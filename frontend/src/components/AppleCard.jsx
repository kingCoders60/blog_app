...
export function AppleCard() {
  ...
  return (
    <div className="w-full h-full py-20">
      <h2
        className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans transition-colors duration-300">
      ...
      {[...new Array(1).fill(1)].map((_, index) => {
        return (
          <div
            ...
            className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-4 transition-colors duration-300">
            <p
              className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto transition-colors duration-300">
